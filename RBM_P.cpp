...
void RBM_P::update_hidden_p(double* vs, int* mask, int mask_size, double* hp) {
...
void RBM_P::update_visible_p(double* hs, double* vp, int* mask, int mask_size) {
    // Compute p(V | h) into vp
...
void RBM_P::update_w_p(double* w_acc, int* w_count, int nth) {
    // Pop parameters
...
void RBM_P::update_vb_p(double* vb_acc, int* vb_count, int nth) {
    // Pop parameters
...
void RBM_P::update_hb_p(double* hb_acc, int nth) {
    // Pop parameters
    int batch_size = *(int*) getParameter("batch_size");
...
void RBM_P::sample_visible_p(double* vp, double* vs, int* mask, int mask_size) {
